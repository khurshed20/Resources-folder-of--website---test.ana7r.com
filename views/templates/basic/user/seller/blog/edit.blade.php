                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('user.blog-store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sel_cate" name="sel_cate" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control mySubCatgry" id="sel_sub_cate" name="sel_sub_cate" required>
                                                @foreach ($sub_categories as $item)
                                                    <option value="{{$item->id}}" @if($data->sub_category->id == $item->id) selected @endif>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    @foreach($section->element as $k => $content)
                                        @if($k == 'images')
                                            ...
                                            @endforeach
                                            <div class="@if($imgCount > 1) col-md-12 @else col-md-12 @endif">
                                                @push('divend')
                                            </div>
                                                @endpush
                                ...
                                <div class="form-group">
                                    @if(@$data)
                                   <button type="submit"  class="btn btn--primary btn-block btn-lg" style="background-color: #20c997; color: #ffffff; border-radius: 5px;">@lang('Publish')</button>
                                    <button type="submit" name="save_as_draft" value="save_as_draft" class="btn btn--primary btn-block btn-lg" style="background-color: #e5ae0b; color: #ffffff; border-radius: 5px;">@lang('Save As Draft')</button>
                                    @else
                                    <button type="submit" class="btn btn--primary btn-block btn-lg" style="background-color: #20c997; color: #ffffff; border-radius: 5px;">@lang('Create')</button>
                                    @endif
                                </div>
                            </form>
                        </div>
