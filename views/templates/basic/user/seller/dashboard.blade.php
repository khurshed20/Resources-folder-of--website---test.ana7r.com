                            ...
                            <div class="row justify-content-center mb-30-none">
                                <div class="col-lg-12 mb-30">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control form-controller" id="referralURL"
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                    <div class="dashboard-item bg--primary">
                                        <a href="{{ route('user.buyer.transactions') }}"
                                            class="dash-btn">@lang('View all')</a>
                                        <div class="dashboard-icon">
                                            <i class="las la-wallet"></i>
                                        </div>
                                        <div class="dashboard-content">
                                            <div class="num text-white">
                                                {{ $general->cur_sym }}{{ showAmount(auth()->user()->balance) }}</div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                                    <div class="dashboard-item bg--success">
                                        ...
                                        <div class="dashboard-content">
                                            <div class="num text-white">
                                                {{ $general->cur_sym }}{{ getAmount($withdrawAmount) }}</div>
