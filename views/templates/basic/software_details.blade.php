                                    ...
                                    <div class="sidebar">
                                        <div class="widget custom-widget mb-30">
                                            ...
                                            <ul class="details-list">
                                                <li><span>@lang('Product Price')</span> <span>{{getAmount($software->amount)}} {{$general->cur_text}}</span></li>
                                            </ul>
                                        ...
                                        <div class="widget custom-widget mb-30">
                                            ...
                                            <ul class="details-list">
                                                ...
                                                @endphp
                                                    ...
                                                    @endforeach
                                                    <li><span><i class="fas fa-truck fa-flip-horizontal"></i><p>Supplier Delivery</p></span> <span><i class="fas fa-truck fa-flip-horizontal"></i><p> Free Delivery</p></span> <span><i class="fas fa-taxi"></i><p>Return</p></span></li>
                                        ...
                                        @foreach($otherServices as $other)
                                            <div class="item-card">
                                                ...
                                                <div class="item-card-footer">
                                                    ...
                                                    <div class="right">
                                                        <div class="order-btn">
                                                            <a href="{{route('user.service.booking', [slug($other->title), encrypt($other->id)])}}" class="btn--base"><i class="las la-shopping-cart"></i> @lang('Order Now')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
