<header class="header-section sticky-header">
    <div class="header">
        ...
        $isShowMobile = false;
        @endphp
                        <button type="button" class="short-menu-open-btn {{ $isShowMobile ? '' : 'd-none' }}"><i class="fas fa-align-center"></i></button>
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav main-menu ms-auto me-auto">
                                ...
                                <li><a href="{{route('software')}}" @if(request()->routeIs('software'))class="active" @endif>@lang('Product')</a></li>
        ...
        $isShow = false;
        @endphp
        <div class="header-short-menu {{ $isShow ? '' : 'category-menu d-none' }} ">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="short-menu">
