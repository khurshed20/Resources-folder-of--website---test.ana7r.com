        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.frontend.sections', ['blog','all']) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.frontend.sections', ['blog','all']) }}">
                                <a href="{{ route('admin.frontend.sections', ['blog','all']) }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item ">
                                <a href="{{ route('admin.frontend.sections', ['blog','published']) }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Published')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item ">
                                <a href="{{ route('admin.frontend.sections', ['blog','pending']) }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item ">
                                <a href="{{ route('admin.frontend.sections', ['blog','rejected']) }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
