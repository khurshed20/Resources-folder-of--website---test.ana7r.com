                                ...
                                <tbody class="list">
                                    @forelse($elements as $data)
                                        <tr>
                                            ...
                                            <td>
                                               @if ($data->status == 1)
                                                    <span class="bg-success rounded">Published</span>
                                        ...
                                        @endif
                                            ...
                                            <td data-label="@lang('Seller')">
                                                <span class="font-weight-bold">{{!empty($data->users) ? $data->users->fullname : ''}}</span>
                                                <br>
                                                <span class="small">
                                                <a href="{{ !empty($data->users) ? route('admin.users.detail', $data->user_id):'#' }}"><span>@</span>{{ !empty($data->users) ? $data->users->username :''}}</a>
                                                </span>
                                            </td>
                                            @foreach ($section->element as $k => $type)
                                                @if ($k != 'modal')
