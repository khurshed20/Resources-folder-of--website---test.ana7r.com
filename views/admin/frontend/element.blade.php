                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel_cate" name="sel_cate" required>
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <option value="{{$category->id}}"@if($edit) @if($data->category->id == $category->id) selected   @endif @endif>{{$category->name}} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel_sub_cate" name="sel_sub_cate" required>
                                        @if ($edit)
